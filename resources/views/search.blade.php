								...
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									<div class="product">
										...
										<div class="product-body">
											<p class="product-category">Category  {{ $row->protype->type_name }}</p>
						...
						<div class="products-tabs">
							...
							<div id="tab2" class="tab-pane fade in active">
								<div class="products-slick" data-nav="#slick-nav-2">
									...
									<div class="product">
										<div class="product-img">
											<img src="./img/product06.png" alt="" href="{{ url('blank')}}">
											<div class="product-label">
												<span class="sale">-30%</span>
												<span class="new">NEW</span>
											</div>
									...
									<div class="product">
										<div class="product-img">
											<img src="./img/product07.png" alt="" href="{{ url('blank')}}">
											<div class="product-label">
												<span class="new">NEW</span>
											</div>
										</div>
									...
									<div class="product">
										<div class="product-img">
											<img src="./img/product08.png" alt="" href="{{ url('blank')}}">
											<div class="product-label">
												<span class="sale">-30%</span>
											</div>
										</div>
									...
									<div class="product">
										<div class="product-img">
											<img src="./img/product09.png" alt="" href="{{ url('blank')}}">
										</div>
										<div class="product-body">
											<p class="product-category">Category</p>
											<h3 class="product-name"><a href="{{ url('product')}}">product name goes here</a></h3>
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-3">
						...
						<div>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/product02.png" alt="" href="{{ url('blank')}}">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="{{ url('product')}}">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/product03.png" alt="" href="{{ url('blank')}}">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="{{ url('product')}}">product name goes here</a></h3>
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-4">
						<div>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/product04.png" alt="" href="{{ url('blank')}}">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="{{ url('product')}}">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/product05.png" alt="" href="{{ url('blank')}}">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="{{ url('product')}}">product name goes here</a></h3>
